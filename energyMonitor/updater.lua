--[[
    Energy Monitor - Bootstrap Updater
    
    This is a lightweight bootstrap script that downloads and runs the 
    centralized CCScripts updater for this specific script.
    
    Usage:
        wget https://raw.githubusercontent.com/respiteJetfire/ccs/main/energyMonitor/updater.lua
        updater
    
    Or for fresh install:
        wget run https://raw.githubusercontent.com/respiteJetfire/ccs/main/energyMonitor/updater.lua
    
    @version 2.0.2
    @author CCScripts
]]

local SCRIPT_NAME = "energyMonitor"
local VERSION = "2.0.2"

print("[INFO] Energy Monitor Bootstrap v" .. VERSION)
print("")

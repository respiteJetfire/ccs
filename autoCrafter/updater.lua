--[[
    Auto Crafter - Bootstrap Updater
    ...
    Or for fresh install:
        wget run https://raw.githubusercontent.com/respiteJetfire/ccs/main/autoCrafter/updater.lua
    
    @version 2.0.3
    @author CCScripts
]]

local SCRIPT_NAME = "autoCrafter"
local VERSION = "2.0.3"

print("[INFO] Auto Crafter Bootstrap v" .. VERSION)
print("")

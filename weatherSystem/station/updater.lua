--[[
    Weather Station - Bootstrap Updater
    
    This is a lightweight bootstrap script that downloads and runs the 
    centralized CCScripts updater for this specific script.
    
    Usage:
        wget https://raw.githubusercontent.com/respiteJetfire/ccs/main/weatherSystem/station/updater.lua
        updater
    
    Or for fresh install:
        wget run https://raw.githubusercontent.com/respiteJetfire/ccs/main/weatherSystem/station/updater.lua
    
    @version 2.0.1
    @author CCScripts
]]

local SCRIPT_NAME = "weatherSystem/station"
local VERSION = "2.0.1"

print("[INFO] Weather Station Bootstrap v" .. VERSION)
print("")

--[[
    Weather System Master - Bootstrap Updater
    
    This is a lightweight bootstrap script that downloads and runs the 
    centralized CCScripts updater for this specific script.
    
    Usage:
        wget https://raw.githubusercontent.com/respiteJetfire/ccs/main/weatherSystem/master/updater.lua
        updater
    
    Or for fresh install:
        wget run https://raw.githubusercontent.com/respiteJetfire/ccs/main/weatherSystem/master/updater.lua
    
    @version 2.0.2
    @author CCScripts
]]

local SCRIPT_NAME = "weatherSystem/master"
local VERSION = "2.0.2"

print("[INFO] Weather System Master Bootstrap v" .. VERSION)
print("")
